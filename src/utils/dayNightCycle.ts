 ...
 * Tick-based day/night cycle system.
 *
 * The in-game clock runs on a 0–24 000 tick scale (1 000 ticks ≈ 1 real-world
 * hour in the 24-hour scale).  This module provides pure-function helpers for
 * light intensity, celestial body positioning, and daytime detection that the
 * rendering engine and gameplay hooks consume.
 */
...
/** Convert ticks (0–24 000) to a fractional-hour value (0–24). */
...
/**
 * Check whether the given *fractional-hour* value (0–24 used by GameState)
 * falls inside the daytime window.  Converts to ticks internally.
 */
