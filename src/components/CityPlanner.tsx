...
const BUILDING_TEMPLATES: Partial<Building>[] = [
  { type: 'HOME', name: 'Worker Duplex', voxels: GENERIC_HOUSE_A_VOXELS },
  { type: 'HOME', name: 'Porch House', voxels: GENERIC_HOUSE_B_VOXELS },
  { type: 'HOME', name: 'Brick Rowhouse', voxels: GENERIC_HOUSE_D_VOXELS },
  { type: 'OFFICE', name: 'District Block', voxels: GENERIC_OFFICE_VOXELS },
  ...
  { type: 'INDUSTRIAL', name: 'Processing Plant', voxels: FACTORY_VOXELS },
