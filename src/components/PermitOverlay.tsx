        ...
        {(permit.status === 'AVAILABLE' || permit.status === 'REJECTED') && (
          <>
            <button 
              ...
              title={permit.status === 'REJECTED' ? 'Resubmit: costs $100 and starts bureau review.' : `Standard filing: costs $${permit.cost} and starts bureau review.`}
            ...
            <button 
              ...
              title={`Fast-track filing: costs $${(permit.status === 'REJECTED' ? 100 : permit.cost) * 2}. Higher immediate approval chance.`}
