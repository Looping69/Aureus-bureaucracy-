...
// ── Road network ─────────────────────────────────────────────────────
// All roads removed – buildings will be re-added via the assets folder.
const cityStreets: Record<string, Building> = {};

// ── Building placement ───────────────────────────────────────────────
// All buildings removed – they will be re-added one by one via the
// assets folder.  player_home and mine_entrance are kept without voxels
// because the game needs them for spawn positioning and navigation.
